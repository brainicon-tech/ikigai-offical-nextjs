    ...
    <section className="section-padding">
      <div className="secondary-container">
        <div className="section-heading">
          ...
          <p>
            Guidance and inspiration for the beautiful journey of parenting,
            grounded in the Ikigai philosophy.
          </p>
        </div>
        <h2 className="text-md font-medium color-gray-dark mb-3">
          Featured Article
        </h2>
        <div className="bg-white-50 rounded-lg shadow-lg overflow-hidden md:flex transition duration-300 hover:-translate-y-2 hover:shadow-[0_10px_20px_-5px_rgb(0_0_0/0.08),_0_4px_10px_-4px_rgb(0_0_0/0.05)] ">
          <div className="p-6 flex flex-col justify-center order-2 md:order-1">
            <p className="text-sm font-semibold bg-dark-pink text-color-white rounded-2xl px-2 py-1 text-center max-w-[180px] uppercase tracking-wide">
              CHILD DEVELOPMENT
            </p>
            ...
            <p className="para mt-4">
              Discover how play is more than just fun. It's how children find
              their purpose, develop skills, and understand the world. Learn how
              to create an environment that nurtures their inner 'Ikigai'.
            </p>
            <div className="mt-6">
              <a
                href="#"
